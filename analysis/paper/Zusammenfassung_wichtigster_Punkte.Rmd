...
Wie oben kann auch hier nur mit den Residualwerten des Chi-Quadrat-Tests gearbeitet werden. 
```{r}
...
chi$residuals%>%
  kable()
```
Auffällig ist hier die Altersgruppe der 20-29jährigen, die dem digitalen FDM eine höhere Bedeutung zuweist als erwartet. Ältere Semester tun das gegenteilig. 
